export function Footer() {
  return (
    <footer className="bg-aura-dark py-24 px-6 md:px-12 border-t border-aura-cream/10 relative z-20">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start gap-16">
        <div className="max-w-sm">
          <div className="text-3xl font-serif tracking-[0.3em] text-aura-cream mb-6">AURA</div>
          <p className="text-aura-cream/50 text-sm leading-relaxed mb-10 font-light">
            The smart coffee machine that grinds, brews and steams café-grade coffee — controlled from your phone.
          </p>
        ...
        <div className="flex gap-16 sm:gap-20">
          <div className="flex flex-col gap-6">
            ...
            <a href="#machine" className="text-aura-cream/50 hover:text-aura-cream text-sm transition-colors duration-300">The Machine</a>
            <a href="#app" className="text-aura-cream/50 hover:text-aura-cream text-sm transition-colors duration-300">The App</a>
            <a href="#specs" className="text-aura-cream/50 hover:text-aura-cream text-sm transition-colors duration-300">Specs</a>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <a href="#" className="text-aura-cream/50 hover:text-aura-cream text-sm transition-colors duration-300">Support</a>
            <a href="#" className="text-aura-cream/50 hover:text-aura-cream text-sm transition-colors duration-300">Contact</a>
          </div>
        </div>

        <div className="w-full md:w-auto">
          <h4 className="font-semibold text-aura-cream mb-6 tracking-widest uppercase text-sm">Stay in the loop</h4>
          <div className="flex flex-col gap-4 w-full">
            ...
            />
            <button className="matte-button py-4 text-sm uppercase tracking-widest mt-2">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto mt-24 pt-8 border-t border-aura-cream/10 flex flex-col md:flex-row justify-between items-center text-xs text-aura-cream/40 tracking-wider">
        <p>&copy; {new Date().getFullYear()} Aura Coffee Inc. All rights reserved.</p>
